...
### `doc.file()`
Use this method if you want to create or work with the corresponding JS `File`, filename, extensions, and mime type.
...
### `doc.search()`
Use this method if you want to search for matches for in the document for a given query and attached search algorithm.  This method is useful when returning interface-compatible data for `marks` to highlight matches in a document.  It is also useful in general for computing offsets and derived data in other NLP pipelines and processes.
